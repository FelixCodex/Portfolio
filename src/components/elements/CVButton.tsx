			...
			{language == 'es' ? (
				<div className='dasher anim-dasher p-[2px] rounded-lg shadow-nm hover:shadow-hm transition-[background-color,box-shadow] duration-[400ms] hover:bg-[#51a5ff] hover'>
					<a
						...
						className='inline-flex items-center gap-2 bg-gradient-to-b md:text-lg font-medium from-[#dce9f9] to-[#f0f8ff] text-black px-6 py-3 rounded-lg transition-colors'
					>
						{HERO.CV[language]}
